...
## Purpose
Define the requirements for converting VS Code remote workspace URIs from the incorrect `vscode-remote://` format to the correct `vscode://vscode-remote/` format that VS Code's protocol handler recognizes.
