...
The system MUST extract workspace attributes from configuration files. The scanner returns `lastAccessed` (access time of storage directory) instead of `lastModified` (modification time of workspace.json).
