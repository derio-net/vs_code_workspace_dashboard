# macos-code-signing Specification

## Purpose
Define macOS code signing with an Apple Development certificate, CI integration, setup documentation, and the upgrade path to Developer ID notarization.
